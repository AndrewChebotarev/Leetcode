...
namespace Digit_Frequency_Score
{
    ...
    {
        private static int n1 = 122;
        private static int n2 = 101;

        public static void Main(string[] args)
        {
            Digit_Frequency_Score digit_Frequency_Score1 = new(n1);
            Digit_Frequency_Score digit_Frequency_Score2 = new(n2);
        }
    }
}
