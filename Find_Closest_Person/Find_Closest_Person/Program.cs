...
namespace Find_Closest_Person
{
    public class Program
    {
        ...
        private static int z3 = 3;

        public static void Main(string[] args)
        {
            Find_Closest_Person find_Closest_Person1 = new(x1, y1, z1);
            Find_Closest_Person find_Closest_Person2 = new(x2, y2, z2);
            Find_Closest_Person find_Closest_Person3 = new(x3, y3, z3);
        }
    }
}
