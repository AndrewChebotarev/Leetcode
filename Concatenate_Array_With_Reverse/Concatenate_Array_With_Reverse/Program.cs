...
namespace Concatenate_Array_With_Reverse
{
    public class Program
    {
        ...
        private static int[] nums2 = { 1 };
        public static void Main(string[] args)
        {
            Concatenate_Array_With_Reverse concatenate_Array_With_Reverse1 = new(nums1);
            Console.WriteLine();
            Concatenate_Array_With_Reverse concatenate_Array_With_Reverse2 = new(nums2);
        }
    }
}
