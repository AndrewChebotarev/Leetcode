...
namespace Merge_Nodes_in_Between_Zeros
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Merge_Nodes_in_Between_Zeros merge_Nodes_in_Between_Zeros1 = new Merge_Nodes_in_Between_Zeros(head1);
            Merge_Nodes_in_Between_Zeros merge_Nodes_in_Between_Zeros2 = new Merge_Nodes_in_Between_Zeros(head2);
        }
    }
}
