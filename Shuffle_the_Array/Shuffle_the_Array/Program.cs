...
namespace Shuffle_the_Array
{
    public class Program
    {
        ...
        {
            Shuffle_the_Array shuffle_The_Array = new();

            int[] result = shuffle_The_Array.Shuffle(nums1, n1);
            SetResultConsole(result);

            result = shuffle_The_Array.Shuffle(nums2, n2);
            SetResultConsole(result);

            result = shuffle_The_Array.Shuffle(nums3, n3);
            SetResultConsole(result);
        }
