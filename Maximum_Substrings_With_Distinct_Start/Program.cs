...
namespace Maximum_Substrings_With_Distinct_Start
{
    ...
    {
        private static string s1 = "abab";
        private static string s2 = "abcd";
        private static string s3 = "aaaa";
        public static void Main(string[] args)
        {
            Maximum_Substrings_With_Distinct_Start maximum_Substrings_With_Distinct_Start1 = new(s1);
            Maximum_Substrings_With_Distinct_Start maximum_Substrings_With_Distinct_Start2 = new(s2);
            Maximum_Substrings_With_Distinct_Start maximum_Substrings_With_Distinct_Start3 = new(s3);
        }
    }
}
