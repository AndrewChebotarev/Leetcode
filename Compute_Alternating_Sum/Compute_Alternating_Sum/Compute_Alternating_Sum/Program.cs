...
namespace Compute_Alternating_Sum
{
    ...
    {
        private static int[] nums1 = { 1, 3, 5, 7 };
        private static int[] nums2 = { 100 };

        public static void Main(string[] args)
        {
            Compute_Alternating_Sum compute_Alternating_Sum1 = new(nums1);
            Compute_Alternating_Sum compute_Alternating_Sum2 = new(nums2);
        }
    }
}
